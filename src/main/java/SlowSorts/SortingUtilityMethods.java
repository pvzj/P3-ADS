...
public class SortingUtilityMethods {
   ...
   public static void performSort(int[] original, int[] expected) {
       ...
       int[] originalCopy = Arrays.copyOf(original, n);
       BogoSort.sort(originalCopy, n);
       System.out.println("BOGOSORT PASSED?: " + 
               Arrays.equals(originalCopy, expected));
       
       originalCopy = Arrays.copyOf(original, n);
       BubbleSort.sort(originalCopy, n);
       System.out.println("BUBBLESORT PASSED?: " + 
               Arrays.equals(originalCopy, expected));
       
       originalCopy = Arrays.copyOf(original, n);
       SelectionSort.sort(originalCopy, n);
       System.out.println("SELECTIONSORT PASSED?: " + 
               Arrays.equals(originalCopy, expected));
       
       originalCopy = Arrays.copyOf(original, n);
       InsertionSort.sort(originalCopy, n);
